...
class MovieRemoteDataSourceImpl implements MovieRemoteDataSource {
  ...
  Future<List> categoryMovies() async {
    final response = await _client.get(Uri.parse("$baseURL/the-loai"));
  ...
  Future<Map> categoryDetailMovies(
    ...
    final response = await _client.get(Uri.parse(
        "$baseURL/v1/api/the-loai/$type?page=$page&sort_type=$sortType&country=$country&year=$year&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<List> countryMovies() async {
    final response = await _client.get(Uri.parse("$baseURL/quoc-gia"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> countryDetailMovies(
    ...
    final response = await _client.get(
        Uri.parse("$baseURL/v1/api/quoc-gia/$country?page=$page&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> yearDetailMovies(String year, int page, int limit) async {
    final response = await _client
        .get(Uri.parse("$baseURL/v1/api/nam/$year?page=$page&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> newlyUpdatedMovies(int page) async {
    final response = await _client
        .get(Uri.parse("$baseURL/danh-sach/phim-moi-cap-nhat?page=$page"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> newlyUpdatedMoviesV3(int page) async {
    final response = await _client
        .get(Uri.parse("$baseURL/danh-sach/phim-moi-cap-nhat-v3?page=$page"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> searchMovies({
    ...
    final response = await _client.get(Uri.parse(
        "$baseURL/v1/api/tim-kiem?keyword=$keyword&limit=$limit&${filters?.toQueryString()}"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> dramaMovies(int page, int limit) async {
    final response = await _client.get(
        Uri.parse("$baseURL/v1/api/danh-sach/phim-bo?page=$page&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> singleMovies(int page, int limit) async {
    final response = await _client.get(
        Uri.parse("$baseURL/v1/api/danh-sach/phim-le?page=$page&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> cartoonMovies(int page, int limit) async {
    final response = await _client.get(Uri.parse(
        "$baseURL/v1/api/danh-sach/hoat-hinh?page=$page&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> tvShowsMovies(int page, int limit) async {
    final response = await _client.get(Uri.parse(
        "$baseURL/v1/api/danh-sach/tv-shows?page=$page&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> vietSubMovies(int page, int limit) async {
    final response = await _client.get(Uri.parse(
        "$baseURL/v1/api/danh-sach/phim-vietsub?page=$page&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> narratedMovies(int page, int limit) async {
    final response = await _client.get(Uri.parse(
        "$baseURL/v1/api/danh-sach/phim-thuyet-minh?page=$page&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map> dubbedMovies(int page, int limit) async {
    final response = await _client.get(Uri.parse(
        "$baseURL/v1/api/danh-sach/phim-long-tieng?page=$page&limit=$limit"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
  ...
  Future<Map?> singleDetailMovies(String nameMovie) async {
    final response = await _client.get(Uri.parse("$baseURL/phim/$nameMovie"));
    if (response.statusCode == 200) {
      return jsonDecode(utf8.decode(response.bodyBytes));
    }
    return null;
